    ...
    <div
        ...
        <div class="bg-white p-2 rounded-lg w-[90vw] h-[65vh] md:w-[25vw] md:h-[60vh] flex flex-col shadow-xl relative md:mr-6 animate-slide-in border border-gray-300">
            ...
            <div
                ...
                style="background-image: url('public/images/whatsapp_chat_bg.png'); background-size: cover; background-blend-mode: overlay;"></div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (!currentUserId) {
            currentUserId = "bravodent_user_" + Math.floor(Math.random() * 100000);
