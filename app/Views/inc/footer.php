 ...
 <footer class="w-full bg-green-50 mt-4" style="font-family: Cambria, Cochin, Georgia, Times, 'Times New Roman', serif;" itemscope itemtype="https://schema.org/DentalClinic">
     <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
         ...
         <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
             ...
             <ul class="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500" itemscope itemtype="https://schema.org/SiteNavigationElement">
                 <li itemprop="name"><a href="AboutUs.php" target="_self" class="text-black hover:text-gray-400" itemprop="url">About Us</a></li>
                 <li itemprop="name"><a href="Privacy&Policy.php" target="_self" class="text-black hover:text-gray-400" itemprop="url">Privacy Policy</a></li>
                 <li class="sm:my-0 my-2" itemprop="name"><a href="Terms&Conditions.php" target="_self" class="text-black hover:text-gray-400" itemprop="url">Terms and Conditions</a></li>
                 <li class="sm:my-0 my-2" itemprop="name"><a href="Blogs.php" target="_self" class="text-black hover:text-gray-400" itemprop="url">Blogs</a></li>
                 <li itemprop="name"><a href="ContactUs.php" target="_self" class="text-white hover:text-gray-400" itemprop="url">Contact Us</a></li>
             </ul>
