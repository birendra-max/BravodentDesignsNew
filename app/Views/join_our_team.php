<script>
    document.title = 'Join Our Team | BravoDent Designs';
</script>
...
<section aria-labelledby="careers-heading">
    <div class="max-w-7xl mx-auto px-6 md:py-24 py-8">
        <!-- Section Header -->
        <div class="text-center mb-12">
            <h1 id="careers-heading" class="md:text-5xl text-3xl font-extrabold text-blue-800">Join the BravoDent Team</h1>
            <p class="text-lg text-gray-700 mt-4 leading-relaxed max-w-3xl mx-auto">
                Be a part of a transformative dental design company, where innovation meets excellence. Explore open positions and take the next step in your career today.
            </p>
        </div>
        ...
        <div class="space-y-10" itemscope itemtype="https://schema.org/ItemList">
            ...
            <div class="bg-white p-8 rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105 border-l-4 border-blue-500 hover:border-blue-700" itemprop="itemListElement" itemscope itemtype="https://schema.org/JobPosting">
                ...
                <meta itemprop="hiringOrganization" content="BravoDent" />
            </div>
            <!-- Position Card 2 -->
        ...
        <div class="mt-12 text-center">
            <p class="text-lg text-gray-700 leading-relaxed mb-6">
                ...
                <a href="mailto:info@bravodentdesigns.com" target="_self" class="text-blue-600 underline hover:text-blue-800" aria-label="Email BravoDent at info@bravodentdesigns.com">info@bravodentdesigns.com</a>
                or click the button below to apply now!
            </p>
            <a href="mailto:careers@bravodentdesigns.com" target="_self" class="inline-block bg-gradient-to-r from-blue-500 to-blue-600 text-white font-semibold py-3 px-8 rounded-full shadow-lg hover:bg-gradient-to-r hover:from-blue-600 hover:to-blue-700 transition-all duration-300 hover:scale-105" aria-label="Apply now by emailing careers@bravodentdesigns.com">
                Apply Now
            </a>
        </div>
    </div>
